            ...
            <div className="pt-6 md:pt-[60px] pb-[10px] md:pb-10 grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-5">
                {
                    impactData.map((impact, index) => (
                        <GradientBorderWrapper
                            ...
                            angle="50deg"
                        >
                            <div className='p-6 bg-gradient-to-br from-primary-red from-[-40%] via-deep-navy via-[50%] to-primary-red to-[150%] rounded-3xl flex flex-col gap-6'>
                                <p className="text-base md:text-[22px] font-bold text-center text-primary-red">Weeks instead of months</p>
                                <p class="text-sm md:text-lg text-center text-white/70">Faster Launch</p>
                            </div>
                        </GradientBorderWrapper>
                    ))
                }
